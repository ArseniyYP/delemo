    ...
    <main>
        ...
        <form action="" method="post">
            <table>
                ...
                <tr>
                    <td><label for="problem_comment">Комментарий</label></td>
                    <td><textarea name="problem_comment" id="problem_comment"></textarea></td>
                </tr>
                <tr>
                    <td></td>
        ...
        <?php
        require_once("db.php");
        if (!empty($_POST['problem_id']) && !empty($_POST['problem_comment'])) {
            $problem_id = $_POST['problem_id'];
            $problem_comment = $_POST['problem_comment'];
            $result = mysqli_query($link, "UPDATE problems SET problem_comment = '$problem_comment' WHERE problem_id = '$problem_id'");
            if ($result == 'true') {
